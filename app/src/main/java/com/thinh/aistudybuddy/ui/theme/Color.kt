...
val SurfaceContainerHigh = Color(0xFF1B2B3F)

val PrimaryNeonTeal = Color(0xFF00E5FF)
val SecondaryTangerine = Color(0xFFFF9800)
val TertiaryCosmicIndigo = Color(0xFF4344D1)
